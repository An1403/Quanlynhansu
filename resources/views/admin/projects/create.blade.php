...
@php
    ...
    $breadcrumb = '<a href="' . route('admin.dashboard') . '">Home</a> / <a href="' . route('admin.projects.index') . '">Dự án</a> / Thêm mới';
@endphp
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('status') error @enderror" id="status" name="status">
                    <option value="In progress" {{ old('status') == 'In progress' ? 'selected' : '' }}>Đang thực hiện</option>
            ...
            <div class="form-group full-width">
                ...
                <textarea 
                    ...
                    name="description" 
                    rows="5" 
                    placeholder="Nhập mô tả chi tiết về dự án...">{{ old('description') }}</textarea>
                @error('description')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
...
<script>
    ...
    console.log('✅ Project create form loaded');
</script>
@endpush