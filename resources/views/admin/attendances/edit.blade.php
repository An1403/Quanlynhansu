...
@php
    $pageTitle = 'Sửa Chấm công';
    $breadcrumb = '<a href="' . route('admin.dashboard') . '">Home</a> / <a href="' . route('admin.attendances.index') . '">Chấm công</a> / Sửa';
@endphp
...
<div class="page-header">
    <h1><i class="fas fa-edit"></i> Sửa Chấm công</h1>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    id="working_hours" 
                    name="working_hours" 
                    value="{{ old('working_hours', $attendance->working_hours) }}"
                    step="0.5"
                    min="0"
                    readonly>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    class="form-control" 
                    value="{{ \Carbon\Carbon::parse($attendance->created_at)->format('d/m/Y H:i') }}" 
                    disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    class="form-control" 
                    value="{{ \Carbon\Carbon::parse($attendance->updated_at)->format('d/m/Y H:i') }}" 
                    disabled>
            </div>
        </div>
    </div>
