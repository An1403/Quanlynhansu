...
@php
    ...
    $breadcrumb = '<a href="' . route('admin.dashboard') . '">Home</a> / <a href="' . route('admin.departments.index') . '">Phòng ban</a> / Sửa';
@endphp
...
<div class="page-header">
    <h1><i class="fas fa-edit"></i> Sửa Phòng ban: {{ $department->name }}</h1>
        ...
        <div class="form-grid">
            ...
            <div class="form-group full-width">
                ...
                <textarea 
                    ...
                    name="description" 
                    rows="6" 
                    placeholder="Nhập mô tả chi tiết về phòng ban, chức năng, trách nhiệm...">{{ old('description', $department->description) }}</textarea>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    class="form-control" 
                    value="{{ \Carbon\Carbon::parse($department->created_at)->format('d/m/Y H:i') }}" 
                    disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <input 
                    type="text" 
                    class="form-control" 
                    value="{{ \Carbon\Carbon::parse($department->updated_at)->format('d/m/Y H:i') }}" 
                    disabled>
            </div>
        </div>
    </div>
